...
#cooccur_all = pd.read_csv(path+folder+'cooccur_df10.csv')
...
#                   batch_size=1024*8, epochs=80, earlystop_patience=10, reducelr_patience=2)
#embeds = gms.get_embed_mat()

embeds = np.load(path+folder+'embed_mats/{}/embed_mats_{}_{}_{}_{}{:.1f}_{}.npz'.format(DX1_rarecutpoint, DX1_dim, DX_dim, PR_dim, penalty_metric, penalty, count_cap))
...
with open(result_file.format(job_index), 'a') as f:
    f.write('{},{},{},{},{},{},{:.1E},{:.1E},{:.1f},{},{},{},{},{},{:.1f},{},{},{},{},{},{},{},{:.5f},{:.5f},{:.5f},{}\n'.format(model_name, DX1_dim, DX_dim, PR_dim, hosp_embed_dim, fc_width, lr1, lr2, dropout, batchsize, embed_file, cohort, tst_seed, n_fold, penalty, penalty_metric, count_cap, DX1_rarecutpoint, DX_rarecutpoint, PR_rarecutpoint, other_pred, ndxpr, auc_mean, auc_avg, auc_freeze_mean, y_pred_file))
