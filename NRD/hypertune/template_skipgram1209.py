...
parser.add_argument('--n_val_folds', type=int, default=10, help='number of folds to split training/validation data')
...
y_pred_lst = []
auc_lst = []
skf = StratifiedKFold(n_splits=n_val_folds, random_state=24, shuffle=True)
for trn_idx, val_idx in skf.split(train_df, train_df.HOSP_NRD):
...
with open(result_file.format(job_index), 'a') as f:
    f.write('{},{},{},{},{},{:.1E},{:.1f},{},{},{},{},{},{:.3f},{},{:.5f},{:.5f},{}\n'.format(model_name, code_embed_dim, hosp_embed_dim, fc_width, md_width, lr1, dropout, batchsize, embed_file, cohort, tst_seed, n_fold, lamb, n_samples, auc_mean, auc_avg, y_pred_file))