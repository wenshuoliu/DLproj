...
parser.add_argument('--sum_layer', type=int, default=0, help='1 is SetSum, 0 is MaskedSum, 2 is lstm')
...
from keras.layers import Input, Embedding, concatenate, LSTM, Lambda, Reshape
...
DX_feature = LSTM(DX_embed_dim)(DX_embed)   
...
auccheckpoint = AUCCheckPoint(filepath=model_path+'amiccs_lstm_temp0.h5', validation_y=Y_val[:, 1], validation_x=[demo_mat_val, DX1_mat_val, DX_mat_val, hosp_array_val])
