...
labels = pd.read_csv(path+'cross_validation/train_labels3.csv')
...
checkpointer = ModelCheckpoint(filepath=model_path+'binary3_valloss3.h5', verbose=0, save_best_only=True, 
                               save_weights_only=True)
auccheckpt = AUCCheckPoint(filepath=model_path+'binary3_auc3.h5', 
