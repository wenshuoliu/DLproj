...
labels = pd.read_csv(path+'cross_validation/train_labels4.csv')
...
checkpointer = ModelCheckpoint(filepath=model_path+'binary3_valloss4.h5', verbose=0, save_best_only=True, 
                               save_weights_only=True)
auccheckpt = AUCCheckPoint(filepath=model_path+'binary3_auc4.h5', 
