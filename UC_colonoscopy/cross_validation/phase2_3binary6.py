...
labels = pd.read_csv(path+'cross_validation/train_labels6.csv')
...
checkpointer = ModelCheckpoint(filepath=model_path+'binary3_valloss6.h5', verbose=0, save_best_only=True, 
                               save_weights_only=True)
auccheckpt = AUCCheckPoint(filepath=model_path+'binary3_auc6.h5', 
