...
checkpointer = ModelCheckpoint(filepath=model_path+'binary4_valloss_0528.h5', verbose=0, save_best_only=True, save_weights_only=True)
auccheckpt = AUCCheckPoint(filepath=model_path+'binary4_auc_0528.h5', 
                           validation_y=val_df[['Inflamm_Mayo_0', 'Inflamm_Mayo_1', 'Inflamm_Mayo_2', 'Inflamm_Mayo_3']].values,
...
with open('output/binary4_0528.pkl', 'wb') as f:
    pickle.dump(hist.history, f, -1)

with open('output/binary4_auc_0528.pkl', 'wb') as f:
