...
tst_itr = tst_gen.flow_from_frame(data_path, video_labels, 'filename', ['split0_123', 'split01_23', 'split012_3'], 
...
for tst_seed in range(10):
    ...
    np.save('output/y_pred_video_auc{}.npy'.format(tst_seed), y_pred_avg)
...
np.savez('output/CV_video_auc.npz', auc01_23=auc01_23, sensi01_23=sensi01_23, speci01_23=speci01_23, ppv01_23=ppv01_23, 
